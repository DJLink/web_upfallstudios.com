    ...
    <div id="content">
        ...
        <?php 
			for( $i = 0; $i < count($platforms); $i++ )
			{
				...
				echo( '<a href="https://www.'.parseLink($link).'/">'.$name.'</a><br/>' );
			}
		?>
        </p>
        ...
        <?php
			for( $i = 0; $i < count($trailers); $i++ )
			{
				...
				if( strlen($youtube) + strlen($vimeo) > 0 )				
				{
					...
					$result = "";
					if( strlen( $youtube ) > 0 ) $result .= '<a href="https://www.youtube.com/?v='.$youtube.'">YouTube</a>, ';
					if( strlen( $vimeo ) > 0 ) $result .= '<a href="https://www.vimeo.com/'.$vimeo.'">Vimeo</a>, ';
					...
					if( strlen( $youtube ) > 0 ) 
					{
						echo('<iframe width="720" height="396" src="https://www.youtube.com/embed/'.$youtube.'" frameborder="0" allowfullscreen></iframe>');
					}
					else
					{
						echo('<iframe src="https://player.vimeo.com/video/'.$vimeo.'" width="720" height="540" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>');
					}
				}
				else
				{
        ...
        <?php 
			for( $i = 0; $i < count($quotes); $i++ )
			{
				...
				<cite>- '.$name.', <a href="https://www.'.parseLink($link).'/">'.$website.'</a></cite></li>' );
			}
		?>
        </ul>
        </div>
        ...
        <?php 
			for( $i = 0; $i < count($additionals); $i++ )
			{
				...
				echo('<p><strong>'.$title.'</strong><br/>'.$description.' <a href="https://'.parseLink($link).'/" alt="'.parseLink($link).'">'.substr(parseLink($link),0,strpos(parseLink($link), "/")).'</a>.</p>');
			}
		?>
        </div>
        ...
        <?php 
			for( $i = 0; $i < count($credits); $i++ )
			{
				...
				{
					echo('<p><strong>'.$person.'</strong><br/><a href="https://'.parseLink($website).'/">'.$role.'</a>');					
				}
        ...
        <a href="https://www.twitter.com/Vlambeer">twitter.com/Vlambeer</a></p>
        <p><strong>Facebook</strong><br/>
        <a href="https://www.facebook.com/Vlambeer">facebook.com/Vlambeer</a></p>
        <p><strong>Web</strong><br/>
        <a href="https://www.vlambeer.com/">vlambeer.com</a></p>
        </div>

		<!-- Clear -->
        <div class="clear" />

		<p class="credits">press kit template by Rami Ismail (<a href="https://www.vlambeer.com/">Vlambeer</a>) & inspired by Andreas Zecher (<a href="https://www.madebypixelate.com/">madebypixelate</a>)</p>
